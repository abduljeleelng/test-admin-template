...
export default class Home extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Row>
                    <Col style={{backgroundColor:"#FFF",color:"#000", borderRadius:10, margin:10,padding:10}}>
                        <p>Daily Transaction Volumes</p> 
                        <h2> &#x20A6; 2,342</h2>
                    </Col>
                    <Col style={{backgroundColor:"#FFF",color:"#000", borderRadius:10,margin:10,padding:10}}>
                 ...
                 <Row>
                  ...
                  <Row>
                      <Col style={{backgroundColor:"#FFF",color:"#000", borderRadius:10,marginTop:10}}> 
                      <h2>Payments</h2>
                      <hr />
                      <TB data={this.data} />
                      </Col>
